...
def sample_db():
    ...
    if (check_tables):
        ...
        input_code = Input.create('test_input', False, 10.0, None, None, 10.0, None, None, 10, None, None, 100, None, None)
        input_code_2 = Input.create('test_input_1', False, 20.0, None, None, 20.0, None, None, 20, None, None, 200, None, None)
